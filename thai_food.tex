...
\end{recipe}
\begin{recipe}[source=FromMyBowl, preparationtime=5 min]{Basic Peanut Sauce}
		\ingredients[8]{
				\unit[1/2]{cup}  & natural peanut butter \\
				\unit[2]{tbsp}   & soy sauce \\
				\unit[1/2]{tbsp} & finely grated ginger \\
				2                & cloves minced garlic \\
				\unit[1/2]{tbsp} & maple syrup \\
				\unit[2]{tbsp}   & rice vinegar \\
				\unit[1]{tbsp}   & red pepper flakes \\
				\unit[2]{tbsp}   & water \\
		}

		\preparation{
		\step Combine all ingredients. Stir until a smooth sauce forms. If it is not combining easily then allow to sit and resume mixing}
		
		\hint{This sauce is great with fresh spring rolls, tempeh, or over rice and veggies.}
\end{recipe}
\newpage
